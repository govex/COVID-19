...
- time_series/vaccine_data_us_timeline.csv: Contains historical data, updated once a day. Each row is uniquely defined by `Province_State`, `Date`, and `Vaccine_Type`
